                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            ...
                            <!--begin::Add product-->
                            <a href="{{ route('master.consultantcategory.create') }}" class="btn btn-primary">Add Product</a>
                            <!--end::Add product-->
                        </div>
                        <!--end::Card toolbar-->
                    </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="geniustable">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-100px">Child Category</th>
...
<script type="text/javascript">
    ...
    var table = $('#geniustable').DataTable({
           processing: false,
           serverSide: true,
           ajax: "{{route('master.consultantcategory.datatable')}}",

           columns: [
                    { data: 'DT_RowIndex', name: 'DT_RowIndex'},
                    { data: 'title', name: 'title' },
                    { data: 'categorie_id', name: 'categorie_id' },
                    { data: 'subcategorie_id', name: 'subcategorie_id' },
