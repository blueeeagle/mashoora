                            ...
                            <div class="collapse" id="kt_advanced_search_form_new">
                                ...
                                <div class="row g-8 mb-8">
                                    ...
                                    <div class="col-xxl-4">
                                        ...
                                        <input type="text" class="form-control form-control form-control-solid datatable-input" data-col-index='2' name="countrycode" value="" />
                                    </div>
                                    <div class="col-xxl-4">
                                        <label class="fs-6 form-label fw-bolder text-dark">Currency Code</label>
                                        <input type="text" class="form-control form-control form-control-solid datatable-input" data-col-index='3' name="countrycode" value="" />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
