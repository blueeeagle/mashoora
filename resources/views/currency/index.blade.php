        ...
        <div class="card shadow-none rounded-0 w-100">
            ...
            <div class="card-body" id="kt_engage_demos_body">
                ...
                <div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_engage_demos_body" data-kt-scroll-dependencies="#kt_engage_demos_header" data-kt-scroll-offset="5px">
                    ...
                    <div class="row">
                        <div class="col-xxl-4" data-id-filter="countrycode" hidden>
                        ...
                        <div class="col-xxl-4" data-id-filter="currencycode" hidden>
                        ...
                        <div class="col-xxl-4" data-id-filter="price" hidden>
        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Currency</h1>
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted"><a href="{{ route('master.currency.index') }}" class="text-muted text-hover-primary">Document</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        $(document).ready(function () {
            ...
            table = $("#kt_datatable").DataTable({
                ...
                ajax: {
                    ...
                    data: {
                        "_token": "{{ csrf_token() }}",
                        columnsDef : ['id','countryname','countrycode','price','symbol']
                    }
