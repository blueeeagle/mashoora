                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="position-relative w-md-400px me-md-2">
                                    ...
                                    <!--end::Svg Icon-->
                                    <input type="text" class="form-control form-control-solid ps-10 datatable-input" data-col-index='4' mutlplaceholder="Offer Title" />
                                </div>
                                <!--end::Input group-->
                                <!--begin:Action-->
                                <div class="d-flex align-items-center">
                                ...
                                <div class="position-relative w-md-300px me-md-2">
                                    <select class="form-select" id="toogleColum" data-control="select2" data-placeholder="Toggle column" multiple="multiple">
                                        ...
                                        <option selected value="7">Amount ({{ $companeySetting->country->currency->currencycode }})</option>
    ...
    var table = null;
            ...
            table = $("#kt_datatable").DataTable({
                ...
                ajax: {
                    ...
                    data: {
                        "_token": "{{ csrf_token() }}",
                        columnsDef : ['id','firm_consultant','firmID','consultantID','offer_title','Image','description','amount','has_validity','from_date','to_date','categoryID','subCategoryID','status','action']
                    }
