    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="position-relative w-md-400px me-md-2">
                                    ...
                                    <!--end::Svg Icon-->
                                    <input type="text" class="form-control form-control-solid ps-10 datatable-input" data-col-index='1' name="search" value="" placeholder="" />
                                </div>
                                <!--end::Input group-->
                                <!--begin:Action-->
                                <div class="d-flex align-items-center">
                                ...
                                <div class="position-relative w-md-300px me-md-2">
                                    <select class="form-select" id="toogleColum" data-control="select2" data-placeholder="Toggle column" multiple="multiple">
                                        ...
                                        <option selected value="2">Discount / Offer</option>
                                        <option selected value="3">Sort No</option>
                ...
                <div>
                        <!--<button type="button" class="btn btn-light"><span class="bi bi-plus"></span></button>-->
                        <a href="{{ route('other.offer.create') }}" class="btn btn-sm btn-primary" ><span class="bi bi-plus">Create Offer</span></a>
                        <a href="{{ route('other.discount.create') }}" class="btn btn-sm btn-primary" ><span class="bi bi-plus">Create Discount</span></a>
                </div>
               
               
                <!--<ul class="nav nav-tabs nav-line-tabs mb-5 fs-6">-->
                <!--    <li class="nav-item">-->
                <!--        <button class="nav-link active" data-bs-toggle="tab"  value="1" onclick="reload(this)" name="changeIndex" href="#kt_tab_pane_1">Home</button>-->
                <!--    </li>-->
                <!--    <li class="nav-item">-->
                <!--        <button class="nav-link" data-bs-toggle="tab"   value="2" onclick="reload(this)" name="changeIndex" href="#kt_tab_pane_2">Category</button>-->
                <!--    </li>-->
                <!--    <li class="nav-item">-->
                <!--        <button class="nav-link" data-bs-toggle="tab"   value="3"  onclick="reload(this)" name="changeIndex" href="#kt_tab_pane_3">All Category</button>-->
                <!--    </li>-->
                <!--</ul>-->
    ...
    var search =null;
        ...
        $(document).ready(function () {
            ...
            table = $("#kt_datatable").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url : "{{route('activities.config.datatable')}}",
                    type: 'POST',
                    data: {
                        "_token": "{{ csrf_token() }}",
        ...
        function reload(obj){
            ...
            table.column(0).search(obj.value, false, false);
            table.table().draw();   
            // search = obj.value; 
            // console.log(search);
