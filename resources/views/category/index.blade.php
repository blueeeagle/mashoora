            ...
            <div class="card-body" id="kt_engage_demos_body">
                ...
                <div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_engage_demos_body" data-kt-scroll-dependencies="#kt_engage_demos_header" data-kt-scroll-offset="5px">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-8" data-id-filter="categories_id" hidden>
                        ...
                        <div class="col-xxl-4" data-id-filter="tags" hidden>
        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <a href="{{ route('master.category.create') }}" class="btn btn-sm btn-primary" >Category</a>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="position-relative w-md-400px me-md-2">
                                    ...
                                    <!--end::Svg Icon-->
                                    <select class="form-select datatable-input" data-control="select2" data-allow-clear="true" data-col-index='1' data-placeholder="Select type">
        ...
        $(document).ready(function () {
            table = $("#kt_datatable").DataTable({
                ...
                ajax: {
                    ...
                    data: {
                        "_token": "{{ csrf_token() }}",
                        columnsDef : ['id','type','name','categories_id','description','tags','img','display_in_home','status']
                    }
